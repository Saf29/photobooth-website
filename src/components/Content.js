...
function getContent(data) {
  const contentArray = []
  data.allContentJson.edges.forEach((item, index) => {
    ...
    contentArray.push(
      <ProductCard key={index}>
        ...
        <ProductInfo>
          ...
          <Button to="/content" primary="true" round="true" css={`position: absolute; top: 420px; font-size: 14px;`}>{item.node.button}</Button>
        </ProductInfo>
      </ProductCard>
